...
import { awsIcon, awsLambdaIcon, awsApiGatewayIcon, type CustomIcon } from '~/constants/awsIcons';
...
export const primaryItems: SkillItem[] = [
  {
    heading: 'Vue',
    icnData: siVuedotjs,
    proficiency: 5,
...
export const secondaryItems: SkillItem[] = [
  {
    heading: 'Rails',
...
export const studyingItems: SkillItem[] = [
  {
    heading: 'Vercel',
    icnData: siVercel,
    proficiency: 3,
...
export const experiencedItems: SkillItem[] = [
  {
    heading: 'Netlify',
    icnData: siNetlify,
    proficiency: 3,
